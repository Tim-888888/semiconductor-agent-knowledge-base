...
class Settings(BaseSettings):
    ...
    intent_catalog_path: str = "data/intent_catalogs/semikb_intent_catalog_v5.json"
    intent_example_bank_path: str = "data/intent_examples/intent_example_bank_v1.json"
    intent_semantic_grounding_enabled: bool = True
    evidence_sufficiency_enabled: bool = True
    evidence_web_fallback_enabled: bool = True
    evidence_judge_borderline_enabled: bool = True
